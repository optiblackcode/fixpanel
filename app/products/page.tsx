        ...
        <div className="max-w-6xl mx-auto space-y-8">
            ...
            <TabsContent value="investments" className="space-y-4">
              ...
              <div className="p-4 border rounded-lg">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <Button onClick={rebalancePortfolio} size="sm">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <Button 
                  ...
                  onClick={() => toggleInvestmentAction('increase')}
                >
                ...
                <Button 
                  variant="outline" 
                  className={`w-full ${activeInvestmentAction === 'decrease' ? 'bg-red-500 hover:bg-red-600 text-white' : ''}`}
                  onClick={() => toggleInvestmentAction('decrease')}
                >
            ...
            <TabsContent value="savings" className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <Button 
                  ...
                  onClick={() => toggleSavingsAction('increase')}
                >
                  <TrendingUpIcon className="mr-2 h-4 w-4" />
                  Increase Savings
                </Button>
                <Button 
                  variant="outline" 
                  className={`w-full ${activeSavingsAction === 'adjust' ? 'bg-blue-500 hover:bg-blue-600 text-white' : ''}`}
            ...
            <TabsContent value="expenses" className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <Button 
                  ...
                  onClick={() => toggleExpenseAction('reduce')}
                >
                  <TrendingDownIcon className="mr-2 h-4 w-4" />
                  Reduce Expenses
                </Button>
                <Button 
                  variant="outline" 
                  className={`w-full ${activeExpenseAction === 'alert' ? 'bg-yellow-500 hover:bg-yellow-600 text-white' : ''}`}
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <motion.div
              ...
              whileHover={{ boxShadow: "0px 0px 8px rgba(0,0,0,0.1)" }}
            >
          ...
          <div className="text-center">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button size="lg">Generate Financial Report</Button>
              </DropdownMenuTrigger>
              <DropdownMenuContent>
